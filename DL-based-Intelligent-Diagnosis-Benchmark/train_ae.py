...
def parse_args():
    ...
    # basic parameters
    parser.add_argument('--model_name', type=str, default='Sae2d', help='the name of the model')
    parser.add_argument('--data_name', type=str, default='CWRUSlice', help='the name of the data')
    parser.add_argument('--data_dir', type=str, default= "C:/Users/churchill/Desktop/money/西储大学轴承数据中心网站/西储大学轴承数据中心网站", help='the directory of the data')
