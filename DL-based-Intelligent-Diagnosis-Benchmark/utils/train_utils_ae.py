    ...
    def train(self):
        ...
        for epoch1 in range(self.start_epoch, args.max_epoch):
            ...
            for phase in ['train', 'val']:
                ...
                if phase == 'train':
                    train_epochs.append(epoch1)
                    train_loss.append(epoch_loss)
                    train_acc.append(epoch_acc)
                else:
                    val_epochs.append(epoch1)
        ...
        plt.plot(train_epochs,train_acc, label='train_acc')
        plt.xlabel('Epochs')
        plt.ylabel('acc+Loss')
        plt.legend()
        plt.title('Training and Validation Loss')
        # Generate a dynamic file name based on the current iteration or data
        file_name = f'C:/Users/churchill/Desktop/money/DL-based-Intelligent-Diagnosis-Benchmark/pic/train_{args.model_name}.png'  # Using f-string for dynamic file name
        ...
        plt.title('Training and Validation Loss')
        # Generate a dynamic file name based on the current iteration or data
        file_name = f'C:/Users/churchill/Desktop/money/DL-based-Intelligent-Diagnosis-Benchmark/pic/val_{args.model_name}.png'  # Using f-string for dynamic file name
        # Save the plot with the dynamic file name
        plt.savefig(file_name)
        plt.close()
